...
#    classes = ('plane', 'car', 'bird', 'cat', 'deer', 'dog', 'frog', 'horse', 'ship', 'truck')
    ...
    dir = 'FMNIST_LENET5_Size'+str(SIZE) +'_epochs_'+str(epochs) +'_batchsize'+str(batch_size) + '_lr0'+str(lr0) +'_data_divide'+str(args.data_divide)+'_method'+str(args.method) + 'l1' + str(args.l1)
    if UID == 0:
        print(dir)
