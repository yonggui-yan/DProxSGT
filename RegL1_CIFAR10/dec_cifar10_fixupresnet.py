...
#    classes = ('plane', 'car', 'bird', 'cat', 'deer', 'dog', 'frog', 'horse', 'ship', 'truck')
    ...
    dir = 'cifar10_'+str(SIZE) +'_'+ str(args.arch) +'_epochs_'+str(epochs) +'_batchsize'+str(batch_size) + '_lr0'+str(lr0) +'_data_divide'+str(args.data_divide)+'_method'+str(args.method) + 'l1' + str(args.l1)
